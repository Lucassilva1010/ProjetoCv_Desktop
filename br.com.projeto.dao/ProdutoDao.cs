    ...
    public class ProdutoDao
    {
        ...
        public DataTable BuscarProdutosPorNome(string nome)
        {
            try
            {
                //1  Criando o DataTable e o comendo Sql
                DataTable tabelaProduto = new DataTable();
                string sql = "SELECT * FROM bdvendas.tb_produtos Where nome=@nome";
        ...
        public DataTable ListarProdutosPorLetras(string nome)
        {
            try
            {
                ...
                string sql = "SELECT * FROM bdvendas.tb_produtos Where nome like @nome";
        ...
        public void AlterarProduto(Produto obj)
        {
            ...
            {
                //Passo 1 - Comando Sql para inserir os dados no Banco
                string sql = @"Updatetb_produtos set descricao=@descricao,preco=@preco,qtd_estoque=@qtd_estoque,for_id=@for_id
